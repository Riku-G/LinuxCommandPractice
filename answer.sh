...
$ pwd
/c/Users/user/geekationWorkspace/LinuxCommandPractice
...
$ git branch -M main
$ git remote add origin git@github.com:Riku-G/LinuxCommandPractice.git
...
$ ls -la
total 9
drwxr-xr-x 1 user 197609  0 Jun  9 15:41 ./
drwxr-xr-x 1 user 197609  0 Jun  9 15:39 ../
drwxr-xr-x 1 user 197609  0 Jun 12 21:46 .git/
-rw-r--r-- 1 user 197609 69 Jun 12 21:46 README.md
drwxr-xr-x 1 user 197609  0 Jun  9 15:41 practice_dir_1/



# 8. `LinuxCommandPractice`ディレクトリ内に`practice_dir_1`ディレクトリを作成してください。
user@DESKTOP-FMDEU0C MINGW64 ~/geekationWorkspace/LinuxCommandPractice (main)
$ ls -la
total 9
drwxr-xr-x 1 user 197609  0 Jun  9 15:41 ./
drwxr-xr-x 1 user 197609  0 Jun  9 15:39 ../
...
$ find practice_file2.txt
find: ‘practice_file2.txt’: No such file or directory
